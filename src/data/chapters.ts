        ...
        quiz: [
            {
                ...
                options: ["Varians", "Standardavvik", "Gjennomsnitt", "Median"],
                answer: 2,
            },
            {
                question: "Hva måler varians?",
                options: ["Spredning", "Sammenhenger", "Form", "Sentral tendens"],
                answer: 0,
            },
            {
                question: "Hva er IQR et mål på?",
                options: ["Avvik fra null", "Gjennomsnitt", "Varians", "Midtre spredning"],
                answer: 3,
            },
            {
                question: "Hvordan finner man standardavviket?",
                options: ["Sum av verdier", "Rot av variansen", "Kvadrer gjennomsnittet", "Del på n"],
                answer: 1,
            },
            {
        ...
        quiz: [
            {
                ...
                options: ["0", "0.3", "0.7", "1.3"],
                answer: 2,
            },
            {
                question: "Hvis A og B er uavhengige, hva gjelder?",
                options: ["Ingen regel", "$P(A)=P(B)$", "$P(A\\cap B) = P(A)P(B)$", "$P(A\\cap B) = P(A) + P(B)$"],
                answer: 2,
            },
            {
                question: "Hva beskriver $P(A\\mid B)$?",
                options: ["Komplement", "Total sannsynlighet", "Betinget sannsynlighet", "Felles sannsynlighet"],
                answer: 2,
            },
            {
    ...
    },
    {
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ["Avhenger av x", "∞", "1", "0"],
                answer: 2,
            },
            {
                question: "Hva er $F(x)$?",
                options: ["Varians", "PDF", "Gjennomsnitt", "CDF"],
                answer: 3,
            },
            {
            ...
            },
            {
                ...
                options: ["$f_{X,Y} = 0$", "$f_X = f_Y$", "$f_{X,Y} = f_X f_Y$", "$f_{X,Y} = f_X + f_Y$"],
                answer: 2,
            },
        ],
    }, // LITT UVISST HVOR BRA DET ER NED HERFRA
    {
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ["$Var(X)=\\sigma$", "$\\sigma^2 = Var(X)$", "$Var(X)=0$", "$\\sigma = Var(X)^2$"],
                answer: 1,
            },
            {
    ...
    },
    {
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ["$e^{-\\lambda}$", "$0$", "$\\lambda$", "$1/\\lambda$"],
                answer: 3,
            },
            {
